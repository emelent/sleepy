...
Router::route([
  ...
  'migrate/' => function($request){
    ...
    DbManager::newInstance(DSN, DB_HOST, DB_NAME, DB_USER, DB_PASS)->execQuery(
      ...
      INSERT INTO oauth_clients (client_id, client_secret, redirect_uri) VALUES ('$CLIENT_ID', '$CLIENT_SECRET', '$CLIENT_REDIRECT'); "
    );
